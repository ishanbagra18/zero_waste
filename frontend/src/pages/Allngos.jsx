...
export default function Allngos() {
  ...
  useEffect(() => {
    ...
    if (lowerQuery === "") {
      setFilteredNgos(ngos.slice(0, 12));
    } else {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-white pb-24">
      {/* Hero Header */}
      <ParallaxHero
        badgeText="Certified NGO Directory"
        title={
          <>
            Explore Partner <span className="text-emerald-400">Non-Profit NGOs</span>
          </>
        }
        subtitle="Connect with certified humanitarian non-profits, community kitchens, and food distribution organizations."
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-20 space-y-8">
        ...
        <div className="p-4 rounded-3xl bg-slate-900/90 border border-slate-800 backdrop-blur-2xl shadow-xl flex items-center justify-center max-w-xl mx-auto">
          <div className="relative w-full">
            ...
            <input
              type="text"
              placeholder="Search NGO by name, organisation, or location..."
              value={searchQuery}
        ...
        {loadingNgos ? (
          ...
          <div className="p-12 text-center rounded-3xl bg-slate-900/40 border border-slate-800 text-slate-400 text-sm italic max-w-md mx-auto">
            No NGOs match your search query "{searchQuery}".
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="px-2.5 py-1 rounded-full bg-teal-500/10 border border-teal-500/20 text-[10px] uppercase tracking-wider font-bold text-teal-400">
                      {ngo.role || "NGO"}
                    </span>
                  ...
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-xs text-slate-400 flex items-center justify-center gap-1 mt-0.5">
                      ...
                      <span className="line-clamp-1">{ngo.organisation || "Non-Profit NGO"}</span>
                    </p>
                  </div>
                  ...
                  <div className="p-3 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-1.5 text-xs text-slate-300">
                    <div className="flex items-center gap-2 truncate">
                      ...
                      <span className="truncate">{ngo.location || "Regional Station"}</span>
                    </div>
                    <div className="flex items-center gap-2 truncate">
                    ...
                    <div className="flex items-center gap-2 truncate">
                      ...
                      <span className="truncate">{ngo.phone || "Contact via Chat"}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mt-6 pt-4 border-t border-slate-800/80">
                  ...
                  <button
                    ...
                    className="py-2 px-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-400 hover:from-emerald-400 hover:to-teal-300 text-slate-950 text-xs font-extrabold transition flex items-center justify-center gap-1.5 shadow-md shadow-emerald-500/10"
                  >
